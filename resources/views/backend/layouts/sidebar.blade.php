<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #fce0a2; ">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('admin') }}">
            <i class="fas fa-fw fa-tachometer-alt" style="color: #333"></i>
            <span style="color: #333">Dashboard</span></a>
    </li>
    ...
    <!-- Heading -->
    <div class="sidebar-heading" style="color: #333">
        Banner
    </div>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('file-manager') }}">
            <i class="fas fa-fw fa-chart-area" style="color: #333"></i>
            <span style="color: #333">Media Manager</span></a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <span style="color: #333">Banners</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded" style="color: #333">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#categoryCollapse"
            ...
            <i class="fas fa-sitemap" style="color: #333"></i>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#productCollapse"
            style="color: #333" aria-expanded="true" aria-controls="productCollapse">
            <i class="fas fa-cubes" style="color: #333"></i>
    ...
    <li class="nav-item" style="color: #333">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#brandCollapse"
            aria-expanded="true" aria-controls="brandCollapse" style="color: #333">
            <i class="fas fa-table" style="color: #333"></i>
            <span style="color: #333">Brands</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('order.index') }}">
            <i class="fas fa-hammer fa-chart-area" style="color: #333"></i>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('review.index') }}">
            <i class="fas fa-comments" style="color: #333"></i>
            <span style="color: #333">Reviews</span></a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#postCollapse"
            ...
            <i class="fas fa-fw fa-folder" style="color: #333"></i>
            <span style="color: #333">Posts</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#postCategoryCollapse"
            ...
            <i class="fas fa-sitemap fa-folder" style="color: #333"></i>
            <span style="color: #333">Category</span>
        </a>
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages"
            data-parent="#accordionSidebar" style="color: #333">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Category Options:</h6>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#tagCollapse"
            ...
            <i class="fas fa-tags fa-folder" style="color: #333"></i>
            <span style="color: #333">Tags</span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('comment.index') }}">
            <i class="fas fa-comments fa-chart-area" style="color: #333"></i>
            <span style="color: #333">Comments</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('coupon.index') }}">
            <i class="fas fa-table" style="color: #333"></i>
            <span style="color: #333">Coupon</span></a>
    </li>
    <!-- Users -->
    <li class="nav-item">
        <a class="nav-link" href="{{ route('users.index') }}">
            <i class="fas fa-users" style="color: #333"></i>
            <span style="color: #333">Users</span></a>
    </li>


    <!-- Sidebar Toggler (Sidebar) -->
    {{-- <div class="text-center d-none d-md-inline">
        <button class="rounded-circle border-0" id="sidebarToggle" style="color: #333"></button>
    </div> --}}

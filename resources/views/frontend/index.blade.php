...
@section('title', 'GOGet || HOME PAGE')
@section('main-content')

    <div class="container lg:mt-0 mt-5">
        <div style="display: flex; justify-content: center; align-items: center;">

            <div class="col-lg-6 col-12 pb-4">
                <div>
                    <h1> GO Get Something You Need</h1>
                    <p>
                        We always provide good and high quality products
                    </p>
                    <div class="button" style="margin-top: 1rem">
                        <a class="btn" href="{{ route('product-grids') }}" role="button">Shop Now<i
                                class="far fa-arrow-alt-circle-right"></i></i></a>
                    </div>
                </div>
            </div>
            <div>
                <img src="{{ asset('images/hero-pic.gif') }}" alt="First slide">
            </div>
        </div>
    </div>
    <!-- Start Product Area -->
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                @endphp
                                @if ($categories)
                                    <button class="btn" style="background: #fce0a2"data-filter="*">
                                        All Products
                                    </button>
                                    @foreach ($categories as $key => $cat)
                                        <button class="btn"
                                            style="background:none;color: #fce0a2; color: #333;"data-filter=".{{ $cat->id }}">
                                            {{ $cat->title }}
                                        </button>
                                    @endforeach
                                @endif
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    @endphp
                                                    <span>PHP{{ number_format($after_discount, 2) }}</span>
                                                    <del
                                                        style="padding-left:4%;">PHP{{ number_format($product->price, 2) }}</del>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @if ($product->condition == 'hot')
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            <span class="old">PHP{{ number_format($product->price, 2) }}</span>
                                            @php
                                                $after_discount = $product->price - ($product->price * $product->discount) / 100;
                                            @endphp
                                            <span>PHP{{ number_format($after_discount, 2) }}</span>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                                            <div class="content">
                                                ...
                                                <p class="price with-discount">
                                                    PHP{{ number_format($product->discount, 2) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @endphp
                                        <h3><small><del
                                                    class="text-muted">PHP{{ number_format($product->price, 2) }}</del></small>

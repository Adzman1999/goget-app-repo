...
@endsection
@section('title', 'GOGet || PRODUCT DETAIL')
                                ...
                                <div class="short">
                                    ...
                                    <div class="rating-main">
                                        <ul class="rating">
                                            ...
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if ($rate >= $i)
                                                    <li><i class="fa fa-star" style="color: #fe754a"></i></li>
                                                @else
                                                    <li><i class="fa fa-star-o" style="color: #fe754a"></i></li>
                                                @endif
                                            @endfor
                                        </ul>
                                    ...
                                    <p class="price"><span class="discount"
                                            style="color: #333">PHP{{ number_format($after_discount, 2) }}</span><s
                                            style="color: #4444">PHP{{ number_format($product_detail->price, 2) }}</s>
                                    </p>

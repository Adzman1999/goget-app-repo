...
@section('title', 'GOGet || PRODUCT PAGE')
                                ...
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        ...
                                        <div class="product_filter">
                                            <button type="submit" class="btn " style="margin-top: 1rem; ">Filter</button>
                                            <div class="label-input">
                                                <span>Range:</span>
                                ...
                                @foreach ($recent_products as $product)
                                    ...
                                    <div class="single-post first">
                                        ...
                                        <div class="content">
                                            ...
                                            @endphp
                                            <p class="price"><del
                                                    class="text-muted">PHP{{ number_format($product->price, 2) }}</del>
                                                PHP{{ number_format($org, 2) }} </p>
                                        </div>
                                    </div>
                                    <!-- End Single Post -->
                                @endforeach
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            @if (count($products))
                                                ...
                                                <div class="list-content">
                                                    <div class="product-content">
                                                        <div class="product-price">
                                                            ...
                                                            <del>PHP{{ number_format($product->price, 2) }}</del>
                                                        </div>
                                                        <h3 class="title"><a
                                                                href="{{ route('product-detail', $product->slug) }}">{{ $product->title }}</a>
                                                        </h3>
                                ...
                                @endforeach
                            @else
                                <h4 style="margin:100px auto; color: #f82f56">There are no products.
                                </h4>
                            @endif
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        <h3><small><del
                                            ...
                                            PHP{{ number_format($after_discount, 2) }} </h3>

                                    ...
                                    @foreach (Helper::getAllProductFromCart() as $key => $cart)
                                        <tr>
                                            ...
                                            <td class="price" data-title="Price">
                                                <span>PHP{{ number_format($cart['price'], 2) }}</span>
                                            </td>
                                            ...
                                            <td class="total-amount cart_single_price" data-title="Total"><span
                                                    class="money">PHP{{ $cart['amount'] }}</span></td>
                                ...
                                <div class="right">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Cart
                                            Subtotal<span>PHP{{ number_format(Helper::totalCartPrice(), 2) }}</span></li>

                                        @if (session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">You
                                                Save<span>PHP{{ number_format(Session::get('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">You
                                                Pay<span>PHP{{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">You
                                                Pay<span>PHP{{ number_format($total_amount, 2) }}</span></li>
                                        @endif

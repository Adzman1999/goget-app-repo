                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            <li class="d-lg-none d-sm-block">
                                <a href="{{ route('cart') }}" class="single-icon"><i class=" ti-shopping-cart"></i>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @else
                                <li><a href="{{ route('login.form') }}">Login /</a> <a
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <div class="right-bar">
                                        ...
                                        @foreach (Helper::getAllProductFromWishlist() as $data)
                                            ...
                                            <li>
                                                ...
                                                <p class="quantity">{{ $data->quantity }} x - <span
                                                        class="amount">PHP{{ number_format($data->price, 2) }}</span></p>
                                            </li>
                                        @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span
                                                class="total-amount">PHP{{ number_format(Helper::totalWishlistPrice(), 2) }}</span>
                                        </div>
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="{{ route('cart') }}" class="single-icon"><i class=" ti-shopping-cart"></i> <span
                                ...
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span
                                                class="total-amount">PHP{{ number_format(Helper::totalCartPrice(), 2) }}</span>
                                        </div>
